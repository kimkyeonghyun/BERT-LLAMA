...
class ArgParser():
    def __init__(self):
        ...
        job_list = ['preprocessing', 'training', 'resume_training', 'testing', 'submission', 'few_submission']
        self.parser.add_argument('--job', type=str, choices=job_list, default='training',
                                 help='Job to do; Must be given.')
        dataset_list = ['squad', 'squad_v2']
        self.parser.add_argument('--task_dataset', type=str, choices=dataset_list, default='squad',
      ...
      # Path arguments - Modify these paths to fit your environment
        ...
        self.parser.add_argument('--cache_path', type = str, default = f'/HDD/kyeonghyun/model',
        ...
        self.parser.add_argument('--proj_name', type=str, default='Base_QA',
                                 help='Name of the project.')
        model_type_list = ['bert', 'roberta', 'albert', 'electra', 'deberta', 'debertav3', 'bert-large', 'roberta-large']
        self.parser.add_argument('--model_type', type=str, choices=model_type_list, default='bert',
                                 help='Type of the Entailment model to use.')
        llm_model_list = ['llama2', 'llama3', 'mistral0.1', 'mistral0.3', 'Qwen2', 'gemma2', 'falcon']
