...
class ArgParser():
    def __init__(self):
        ...
        self.proj_name = 'Base_Entailment'
        ...
        dataset_list = ['snli', 'mnli']
        self.parser.add_argument('--task_dataset', type=str, choices=dataset_list, default='snli',
        ...
        self.parser.add_argument('--proj_name', type=str, default='Base_Entailment',
